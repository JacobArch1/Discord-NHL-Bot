...
CREATE TABLE IF NOT EXISTS Poker_Pool (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    game_id INTEGER NOT NULL,
    game_type INTEGER NOT NULL,
    guild_id INTEGER NOT NULL,
    ...
    user_pot REAL NOT NULL DEFAULT 0.0,
    opponent_pot REAL NOT NULL DEFAULT 0.0,
    is_user_turn INTEGER NOT NULL DEFAULT 0,
    opponent_accepted INTEGER NOT NULL DEFAULT 0,
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
    updated_at DATETIME DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS Update_List(
    ...
    update_role_id INTEGER NOT NULL DEFAULT 0,
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
    updated_at DATETIME DEFAULT CURRENT_TIMESTAMP
);
